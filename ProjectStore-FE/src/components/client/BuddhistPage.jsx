...
function BuddhistPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get(`${API_BASE_URL}/products/sort/buddhists`, {
          params: {
            page: currentPage,
            size: pageSize,
            sort: sortBy,
    ...
    <div className="flex flex-col min-h-screen bg-[#fff7f3]">
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <h2 className="text-4xl font-bold tracking-widest text-red-700 uppercase relative">Pháp Phục
          ...
          <div className="text-gray-500 text-sm flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-black font-semibold">Pháp Phục</span>
          </div>
