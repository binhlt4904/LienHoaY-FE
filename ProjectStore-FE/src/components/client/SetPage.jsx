...
function SetPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get(`${API_BASE_URL}/products/sort/sets`, {
          params: {
            page: currentPage,
            size: pageSize,
            sort: sortBy,
        ...
        const productSets = res.data.content || [];
        ...
        console.error("Lỗi khi lấy sản phẩm set:", err);
      }
    };
